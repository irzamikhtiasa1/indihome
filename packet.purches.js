...
function sendWhatsApp(contact) {
    ...
    const message = `Hallo Jitu%0ANama: ${name}%0AAlamat: ${address}%0AType: ${packageType}%0APaket: ${packageName}%0ADetail: ${details}%0AHarga: ${price} (Harga belum termasuk PPN 11%)`;
